...
# render.py starts the dashboard from audit.env -- never .env, so a real host named in
# your own .env cannot be reached by a recording run -- and tears it down afterwards.
UI_PORT = 8765
