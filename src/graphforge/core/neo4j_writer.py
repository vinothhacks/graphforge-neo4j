...
class Neo4jWriter:
    def __init__(
        ...
        if self.emit_path:
            ...
            self._emit_fh.write(
                "// Generated by graphforge — replay with cypher-shell or Neo4j Browser\n\n"
            )
    ...
    def _driver_connect(self):
        if self._driver is None:
            ...
            log.info(
                "Connected to Neo4j at %s (database=%s)", self.settings.uri, self.settings.database
            )
        return self._driver
    ...
    # -- operations --------------------------------------------------------
    def write(
        self, ops: Iterable[Operation], desc: str = "writing", *, progress: bool = True
    ) -> int:
