...
def test_ejb_and_managedbean_stereotypes():
    ...
    assert extract(['@ManagedBean', 'public class Ctrl {}'])["classes"][0]["stereotype"] == "ManagedBean"
...
def test_vds_write_rows(tmp_path):
    rows = [
        {"sid": 1, "servicename": "getrskmaster", "query": "SELECT * FROM rskmaster",
         "coretable": "rskmaster", "groupby": "", "orderby": "",
         "tablename": "rskmaster", "columnname": "rskcode", "fieldname": "code"},
        {"sid": 1, "servicename": "getrskmaster", "query": "SELECT * FROM rskmaster",
         "coretable": "rskmaster", "groupby": "", "orderby": "",
         "tablename": "vesselmaster", "columnname": "vcode", "fieldname": "vc"},
    ]
